...
public class MensagemJpaController implements Serializable {
    ...
    public List<Mensagem> findTodasAsMensagens(Usuario usuario){
        EntityManager em = getEntityManager();
        TypedQuery<Mensagem> query;
        
        query = em.createQuery("select l from Mensagem l where l.destinatario=:id or l.remetente=:id", Mensagem.class);
