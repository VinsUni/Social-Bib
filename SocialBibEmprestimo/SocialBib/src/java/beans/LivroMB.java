...
public class LivroMB {
    ...
    /**
     * Insere (cadastra) um novo livro. O dono do livro é preenchido com o
     * usuário que está na sessão e o livro é gravado no banco de dados. Depois
     * disso, o livro deste Bean recebe uma nova instância em branco (new
     * Livro()).
     */
    public void inserir() {
        ...
        if (!isbnJaExiste(livro.getIsbn())) {
            ...
            FacesUtil.adicionarMensagem("formCadastrarLivro:campoIsbn",
                    "Este ISBN já existe.");
        }
    ...
    /**
     * Altera um livro. Pega o livro deste Bean e testa se o id é nulo. Caso
     * seja nulo, é adicionada uma mensagem de erro. Caso contrário, o livro é
     * alterado no banco de dados e uma mensagem de confirmação é adicionada.
     */
    public void alterar() {
        try {
            if (livro.getId() != null) {
    ...
    /**
     * Exclui um livro. Pega o livro deste Bean e testa se o id é nulo. Caso
     * seja nulo, é adicionada uma mensagem de erro. Caso contrário, o livro é
     * excluído do banco de dados. Na exclusão, pode ser lançada a exceção
     * NonexistentEntityException e, caso isso ocorra, uma mensagem de erro é
     * adicionada. Caso contário, adiciona-se uma mensagem de confirmação.
     */
    public void excluir() {
        try {
            if (livro.getId() != null) {
    ...
    public boolean isbnJaExiste(String isbn) {
        Livro l = dao.findLivroPorIsbn(isbn);
        return l != null;
    }

    /**
     * Instancia (set) o livro deste Bean com um livro vindo do banco de dados.
     * Instancia o livro deste Bean com o resultado de uma busca no banco de
     * dados pelo id do livro.
     *
